...
old_model_path = 'models/model-150-9.28.hdf5'

model_path = 'models-re/model-{epoch:02d}-{val_loss:.2f}.hdf5'
if not os.path.exists('models-re'):
    os.makedirs('models-re')
history_path = 'history-re/model-{epoch}.json'
if not os.path.exists('history-re'):
    os.makedirs('history-re')
dump_period = 25
